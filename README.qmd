...
subtitle: "1/12/2026, Leah Weimbs"
format: 
  pdf: default
  gfm: default
editor: visual
...
Question: How does the amount of abalone landings change over time.
...
```{r}
ca_ab <- read.csv("abalone_landings.csv")
ggplot(data = ca_ab, mapping = aes(x = Year, y = Abalone_Landings_lbs, color = Abalone_Species)) +
  geom_point()
ggsave("FUCK.png")
